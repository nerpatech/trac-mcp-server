...
TICKET_RENDER_CHECK_TOOL = types.Tool(
    ...
    description=(
        ...
        "reference stuck in a code span, an unconfigured InterTrac "
        "prefix, and -- render-only -- markup that survived as literal "
        "text instead of converting). Use this right after any "
...
WIKI_RENDER_CHECK_TOOL = types.Tool(
    ...
    description=(
        ...
        "targets, a cross-instance reference stuck in a code span, an "
        "unconfigured InterTrac prefix, and -- render-only -- markup "
        "that survived as literal text instead of converting). Use this "
        "right after any wiki_update/wiki_create write."
    ),
    annotations=types.ToolAnnotations(
        readOnlyHint=True,
        destructiveHint=False,
